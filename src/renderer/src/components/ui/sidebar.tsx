...
function SidebarInset({
  ...
  return (
    <main
      className={cn(
        "relative flex w-full flex-1 flex-col overflow-y-auto bg-background",
        "md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm",
        className
      )}
