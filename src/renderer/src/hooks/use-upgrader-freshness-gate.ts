...
// Stamps `lastRunAt` on the running -> idle transition and reports
// `dataIsStale = true` until a cloudsave lands strictly after that timestamp.
// Run button should be locked while stale.
